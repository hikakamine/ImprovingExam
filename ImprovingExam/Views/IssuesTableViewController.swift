...
class IssuesTableViewController: UITableViewController {
    ...
    var issuesViewModel: IssuesInterface!
    ...
    override func tableView(_ tableView: UITableView,
        ...
        let issuePageViewController = IssuePageViewController()
        issuePageViewController.issuePageViewModel = issuesViewModel.getIssuePageInterface(forIndex: indexPath.row)
...
extension IssuesTableViewController {
    ...
    private func fetchIssues() {
        issuesViewModel.fetchIssues { [weak self] result in
